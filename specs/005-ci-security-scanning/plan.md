...
**Primary Dependencies**: GitHub Actions (`actions/checkout@v4`), `aquasecurity/trivy-action@v0.36.0`, `github/codeql-action` (v3 init/analyze + `upload-sarif`), Dependabot (GitHub-native, `uv` + `github-actions` ecosystems)
