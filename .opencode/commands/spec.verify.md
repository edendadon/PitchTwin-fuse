---
description: Verify feature completeness against specification — test gate, diff analysis,
  and 4-pillar compliance assessment.
handoffs:
...
- label: Extract CDRs from Verification Evidence
  ...
  prompt: Run levelup to extract reusable patterns and CDRs from the verification
    evidence
  send: true
scripts:
